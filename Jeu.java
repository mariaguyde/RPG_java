		...
		while (statusMenus = true) {	
				...
				if (MenuChoix == 1) {
					...
					System.out.println("Bienvenue dans le magasin d'armes !!!" + 
							...
							"1- Épées (50 dinos) / 2- Sabres (60 dinos)/ 3- Pistolets (80 dinos) / 4- Potions magiques (90 dinos) / 5- Baguettes magiques (100 dinos) \n" +
					...
					if (ArmeAchat == 1) {
					    ...
					    if (resultRetrait == true) {
						 ...
						 boolean resultRetrait = joueurInfos.retraitArgentPortefeuille(60, QuantiteArme);
						 ...
						 boolean resultRetrait = joueurInfos.retraitArgentPortefeuille(80, QuantiteArme);
						...
						boolean resultRetrait = joueurInfos.retraitArgentPortefeuille(90, QuantiteArme);
						...
						if (joueurInfos.getXP() > 10) {
							boolean resultRetrait = joueurInfos.retraitArgentPortefeuille(100, QuantiteArme);
